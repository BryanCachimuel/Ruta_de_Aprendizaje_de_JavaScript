...
const miModulo = (() => {
    ...
    */
    ...
    // aquí se informa que se quiere exportar para poder acceder a cada función definida dentro de la función anónima
    return {
        cperimetroCuadrado: calcularPerimetroCuadrado,
        careaCuadrado: calcularAreaCuadrado,
        cperimetroTriangulo: calcularPerimetroTriangulo,
        carearTriangulo: calcularAreaTriangulo,
        cdiametroCirculo: calcularDiametroCirculo,
        cperimetroCirculo: calcularperimetroCirculo,
        careaCirculo: calcularAreaCirculo,
        climpiar: limpiarCampos
    }
